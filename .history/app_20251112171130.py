...
def render_login_signup() -> None:
    ...
    with st.container():
        ...
        feature_items = [
            ("🧭 Guided Sessions", "Blended webcam + manual mood detection tailors playlists instantly."),
            ("🤝 Collaborative Care", "Invite caregivers securely and share progress in real time."),
            ("📈 Longitudinal Insight", "Visual dashboards surface mood trends and session outcomes."),
        ]
        for col, (title, description) in zip(feature_cols, feature_items):
            col.markdown(
